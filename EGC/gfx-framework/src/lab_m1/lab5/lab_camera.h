    ...
    class Camera
    {
     public:
        ...
        void TranslateRight(float distance)
        {
            ...
            position += glm::normalize(projectedRight) * distance;
        }
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 newV = glm::rotate(glm::mat4(1.0f), angle,glm::vec3(right)) * glm::vec4(forward, 1);
            forward = glm::normalize(glm::vec3(newV));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 newV = glm::rotate(glm::mat4(1.0f), angle,glm::vec3(0, 1, 0)) * glm::vec4(forward, 1);
            forward = glm::normalize(glm::vec3(newV));
            newV = glm::rotate(glm::mat4(1.0f), angle,glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 newV = glm::rotate(glm::mat4(1.0f), angle,glm::vec3(forward)) * glm::vec4(right, 1);
            right = glm::normalize(glm::vec3(newV));
            up = glm::cross(right, forward);
