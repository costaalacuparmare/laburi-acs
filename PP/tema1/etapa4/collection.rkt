...
(define (collection-empty? collection) (stream-empty? collection))


(define (collection-car collection) (stream-first collection))


(define (collection-cdr collection) (stream-rest collection))


(define (collection-filter func collection) (stream-filter func collection))


(define (collection-map func collection) (stream-map func collection))
