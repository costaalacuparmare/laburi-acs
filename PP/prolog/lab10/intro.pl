...
myConcat([],L,L).
myConcat([H|T1],L,[H|T2]) :- myConcat(T1, L, T2).
...
myReverse([], []).
myReverse([H|T], Rev) :- myReverse(T, RevT), myConcat(RevT, [H], Rev).
...
myReverseAcc([H|T], Acc, Rev) :- myReverseAcc(T, [H|Acc], Rev).
...
descendantOf(Nod1, Nod2):- arc(Nod2, Nod1).
descendantOf(Nod1, Nod2):- arc(Nod2, X), descendantOf(Nod1, X).
...
sameTree(Nod1, Nod2):- descendantOf(Nod1, Nod2); descendantOf(Nod2, Nod1).
sameTree(Nod1, Nod2):- descendantOf(Nod1, X), descendantOf(Nod2, X).
...
drum(Nod, Nod, [Nod, Nod]).
drum(Nod1, Nod2, [Nod1, Nod2]):- arc(Nod1, Nod2); arc(Nod2, Nod1).
drum(Nod1, Nod2, [Nod1|T]):- arc(Nod1, X), descendantOf(Nod2, X), drum(X, Nod2, T).
drum(Nod1, Nod2, [Nod1|T]):- arc(X, Nod1), drum(X, Nod2, T).
...
cost(Nod, Nod, 0).
cost(Nod1, Nod2, 1):- arc(Nod1, Nod2).
cost(Nod1, Nod2, -1):- arc(Nod2, Nod1).
cost(Nod1, Nod2, Cost):- arc(Nod1, X), descendantOf(Nod2, X), cost(X, Nod2, Cost1), Cost is Cost1 + 1.
cost(Nod1, Nod2, Cost):- arc(X, Nod1), cost(X, Nod2, Cost1), Cost is Cost1 - 1.
