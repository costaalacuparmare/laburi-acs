...
HD_PWD='C:/Users/phony/Desktop/Poli/PCLP4/lab2/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sillyfunction.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sillyfunction.tcl -notrace
