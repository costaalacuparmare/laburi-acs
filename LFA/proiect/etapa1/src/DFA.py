...
class DFA[STATE]:
    ...
    def remap_states[OTHER_STATE](self, f: Callable[[STATE], 'OTHER_STATE']) ->\
            'DFA[OTHER_STATE]':
        # optional, but might be useful for subset construction and the lexer
        # to avoid state name conflicts. this method generates a new dfa,
        # with renamed state labels, while keeping the overall structure of
        # the automaton.
