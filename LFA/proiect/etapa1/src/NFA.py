...
EPSILON = ''  # this is how epsilon is represented by the checker in the
# transition function of NFAs
...
class NFA[STATE]:
    ...
    def epsilon_closure(self, state: STATE) -> set[STATE]:
        # compute the epsilon closure of a state (you will need this for
        # subset construction) see the EPSILON definition at the top of this
        # file
    ...
    def remap_states[OTHER_STATE](self, f: 'Callable[[STATE], OTHER_STATE]') \
            -> 'NFA[OTHER_STATE]':
        # optional, but may be useful for the second stage of the project.
        # Works similarly to 'remap_states' from the DFA class. See the
