...
int main(int argc, char *argv[])
{
    ...
    /**
     * Truncate the output file to the input file size. Use `fstat()`
    ...
    /**
     * Copy the contents of the input mapping to the output mapping.
     */
    memcpy(dst, src, statbuf.st_size);

    /* Clean up. Use `munmap()` to unmap the 2 files. */
