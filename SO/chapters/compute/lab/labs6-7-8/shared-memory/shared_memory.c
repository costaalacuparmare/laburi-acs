...
int main(void)
{
	...
	/* Change the flags to disable copy-on-write. */
	...
	*p = 42;
	...
	/**
	 * Create a semaphore in the shared page and use it to signal
	...
	case 0:
		...
		*p = 69;
		...
		/**
		* Wait for the semaphore to be signalled by the
		* parent.
		*/
	...
	default:
		/* Parent process */
		/**
		 * Sleep for a few seconds before signalling the child
		 * process to end.
		 */
		...
		/**
		 * Make sure the value read by the parent is still the
